    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <div class="#">
                            <p class="admin">Quản Lý Đơn Hàng</p>
                <li class="sub-menu">
                    <a href="javascript:;">
                ...
                <div class="#">
                    <p class="admin">Quản Lý Sản Phẩm</p>
                    <li class="sub-menu">
                        <a href="javascript:;">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{ URL::to	('/all-coupon') }}">Quản lý mã giảm giá</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{ URL::to	('/add-type') }}">Thêm Loại</a></li>
                        <li><a href="{{ URL::to	('/all-type') }}">Liệt kê loại sản phẩm</a></li>
                    </ul>
                </li>
                </div>
